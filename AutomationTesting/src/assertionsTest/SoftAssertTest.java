...
//			soft.assertTrue(actualResult,"Log Out link is not displayed");

//			soft.assertFalse(actualResult,"Log Out link is not displayed");
			
//			soft.fail("Intentionally failing the test scripts");
